...
class CAD:
    def __init__(self, model_name: str, device: Union[int,str] = 0):
        ...
        self.model = AutoModelForSeq2SeqLM.from_pretrained(model_name, device_map=device, use_cache=True)
    ...
    def generate(self,
        ...
        sent_lengths = input_ids_with_contexts.new(batch_size).fill_(max_new_tokens)
